...
def cadastrar_usuario():
    ...
    if request.method == 'POST':
                ...
                if not validar_tipo_usuario(perfil):
                    ...
                    if not validar_nome_empresa(empresa):
                        ...
                        if not validar_telefone(telefone):
                            ...
                            erro_externo.append('Por favor, digite um número de telefone válido. Use o formato: (XX) XXXXX-XXXX ou XXXXXXXXXXX.')
                            if not validar_seguimento(seguimento):
                                print("Seguimento inválido")
                                erro_externo.append('Seguimento inválido')
        if erro_externo:
        ...
        user = UserManager()
        try:
            user.register_user(nome, email, telefone, empresa, seguimento, senha, perfil)
        ...
        return render_template('admin/admin.html', mensagem_sucesso="Usuário cadastrado com sucesso!")
